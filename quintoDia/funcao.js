...
let perguntaSimNao = prompt(
  "Você deseja adicionar um alimento a sua lista de compras? (1 - sim ou    2 - não)"
);
...
while (encerrarPrograma === false) {
  while (perguntaSimNao === "1") {
    ...
    var categoria = prompt(
      "Em qual categoria esse alimento se encaixa? ( 1 = frutas, 2 = laticinios, 3 = congelados ou 4 = doces?)"
    );
